...
?>
<?php
$url_remarkreject = $this->Url->build(['controller' => 'Users', 'action' => 'witns']);
    ...
    <body>
        ...
        <div class="container-fluid margin-top-60">
            ...
            <!-- end of progress bar -->
                    ...
                    <?php echo $this->Form->input('user_audio', ['label'=>false,'type' => 'file','id' => 'user_audio','class'=>'hidden']); ?>                                     
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $colleague_complaint = array("Yes" => "Yes", "No" => "No");
                                    ...
                                    <div class="col-md-6" id="resolve">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $resolve_complaint = array("Yes" => "Yes", "No" => "No");
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <!-- <div class="inline-block p-l-20">
                                                        <i class="fa fa-microphone fa-2x" id="start-recording" title="Record audio"></i>
                                                    </div> -->
                                                    <!-- <div class="inline-block p-l-20">
                                                        <i class="fa fa-stop-circle fa-2x" id="stop-recording" title="Stop recording"></i>
                                                    </div> -->
                                                    <!-- <div class="inline-block p-l-20">
                                                        <i class="fa fa-download fa-2x" id="save-recording" title="Download recording"></i>
                                                    </div> -->
<!--                                                    <div class="inline-block p-l-20">
                                                        <i class="fa fa-download fa-2x" id="btn-release-microphone"></i>
                                                    </div>-->
                                                    <!-- <div class="inline-block p-l-20" id="audio-sec" style="display:none;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->input('wi_empid[]', ['label' => 'Employee ID', 'type' => 'text', 'id' => 'witness_emp_id', 'class' => 'form-control']); ?>
                                    <?php echo $this->Form->input('a_useremail[]', ['label' => false, 'type' => 'hidden', 'id' => 'a_useremail', 'class' => 'form-control', 'value' => @h($individual_registered_user_details->email)]); ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="witness_email"></label>
                                    <?php echo $this->Form->input('wi_email_id[]', ['label' => 'Email', 'name' => 'wi_email_id', 'type' => 'text', 'id' => 'witness_email', 'class' => 'form-control']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->input('relationship[]', ['label' => 'Relationship', 'id' => 'witness_relation', 'type' => 'text', 'class' => 'form-control']); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
